...
$url        = 'https://ol-public-artifacts.s3.amazonaws.com/openlegacy-cli/1.31.0/windows/openlegacy-cli.zip' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  checksum      = '5b2cd86f70446182e7efd2eb45ea2dfc88065ae42d25dfc47022c7d4fd6f3944'
...
# Git bash support
$cmdBatch = "$toolsDir\ol\bin\write_to_bash.bat"
Start-ChocolateyProcessAsAdmin -Statements $cmdBatch -ExeToRun "cmd.exe" # Run script to add git bash_profile the 'ol' alias and autocomplete
