...
$url        = 'https://ol-public-artifacts.s3.amazonaws.com/openlegacy-cli/1.41.1/windows/openlegacy-cli.zip' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  checksum      = '5ce6ed8b7360aba03906fa492da881abd55b3b9203dfd48b04411bc04da95873'
